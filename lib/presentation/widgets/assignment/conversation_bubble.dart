...
class ConversationBubble extends StatelessWidget {
  ...
  const ConversationBubble({required this.conversation, super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (conversation.answer.isNotEmpty && conversation.answer != '...')
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                AssignmentContentDisplay(content: conversation.answer),
              ],
            ),
          ),
      ],
